defmodule Vaporator.Client.EventConsumer do
  @moduledoc """
  ...
  def init(_state) do
    ...
    children = [
      %{
        ...
        start: {
          Vaporator.Client.EventProcessor,
          :start_link,
          []
        },
        restart: :temporary
    ...
    GenStage.async_subscribe(
      __MODULE__,
      to: Vaporator.Client.EventProducer,
...
defmodule Vaporator.Client.EventProcessor do
  @moduledoc """
  ...
  def start_link(event) do
    ...
    Task.start_link(fn ->
      Vaporator.Client.process_event(event)
    end)
  end
end
