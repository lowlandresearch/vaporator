defmodule Vaporator.DropboxFileUpdateTest do
  ...
  test "Dropbox hash function" do
    ...
    assert Vaporator.Dropbox.dbx_hash!("./dbx-hash-test.txt") ==
  ...
  test "update a file" do
    ...
    {:ok, meta} =
      Vaporator.CloudFs.file_upload(
        @dbx,
        "./update-test.txt",
        "/vaporator/test/update-test.txt"
      )

    assert meta.path == "/vaporator/test/update-test.txt"

    assert meta.meta["content_hash"] ==
             "6eec1c708f7d1962bd125e2148e4b8580230d7b1ab1e810a048b10575f89edbe"
    ...
    assert meta.meta["content_hash"] ==
             "5b81988c6b0a3d4a95edf8cf5c505e1410286dbff0c6d9201de80872981eabf9"
